...
//              SetGalleryWidth(0);
  ...
  function OpenInternalViewer( imageIdx ) {
    ...
    $g_containerViewerContent = jQuery('<div class="content">' + sImg + '<div class="contentAreaPrevious icon iconfont">&#xe600;</div><div class="contentAreaNext icon iconfont">&#xe602;</div></div>').appendTo($g_containerViewer);
    $g_containerViewerCloseFloating = jQuery('<div class="closeButtonFloating icon iconfont">&#xf003e;</div>').appendTo($g_containerViewer);
    ...
    if( g_supportFullscreenAPI ) {
        fs = '<div class="setFullscreenButton fullscreenButton icon iconfont">&#xe601;</div>';
    }
    $g_containerViewerToolbar = jQuery('<div class="toolbarContainer"><div class="toolbar"><div class="previousButton icon iconfont">&#xe600;</div><div class="pageCounter"></div><div class="nextButton icon iconfont">&#xe602;</div><div class="playButton playPauseButton icon iconfont">&#xf0001;</div>' + fs + '<div class="closeButton icon iconfont">&#xf003e;</div><div class="label"><div class="title"></div><div class="description"></div></div></div>').appendTo($g_containerViewer);
